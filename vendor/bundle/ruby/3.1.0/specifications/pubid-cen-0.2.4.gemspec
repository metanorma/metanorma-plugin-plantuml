# -*- encoding: utf-8 -*-
# stub: pubid-cen 0.2.4 ruby lib

Gem::Specification.new do |s|
  s.name = "pubid-cen".freeze
  ...
  s.bindir = "exe".freeze
  s.date = "2024-03-28"
  s.description = "Library to generate, parse and manipulate CEN PubID.".freeze
  s.email = ["open.source@ribose.com".freeze]
  s.extra_rdoc_files = ["README.adoc".freeze, "LICENSE.txt".freeze]
  s.files = ["LICENSE.txt".freeze, "README.adoc".freeze]
  s.homepage = "https://github.com/metanorma/pubid-cen".freeze
  s.licenses = ["BSD-2-Clause".freeze]
  s.required_ruby_version = Gem::Requirement.new(">= 2.5.0".freeze)
  s.rubygems_version = "3.3.26".freeze
  s.summary = "Library to generate, parse and manipulate CEN PubID.".freeze
